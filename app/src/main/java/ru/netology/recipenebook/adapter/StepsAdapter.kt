...
import ru.netology.recipenebook.databinding.StepDetailsShowBinding
import ru.netology.recipenebook.viewModel.StepsDetailsHelper
                            ...
                            when (item.itemId) {
                                R.id.step_remove -> {
                                    MaterialAlertDialogBuilder(it.context)
                                        .setMessage(it.context.getString(R.string.steps_adapter_string1))
                                        .setNegativeButton(it.context.getString(R.string.steps_adapter_string2)) { dialog, which -> }
                                        .setPositiveButton(it.context.getString(R.string.steps_adapter_string3)) { dialog, which ->
